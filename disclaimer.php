...
<html>
	...
	<body>		
		...
		<div id="innerbody">
			...
			SHOULD NOT BE TRIED OR TESTED ON ANY PRODUCTION NETWORKS WITHIN YOUR ENTERPRISE.<BR>
			VULNERABLE WEB APPLICATION IS MEANT ONLY FOR USE ON ENDPOINTS WITH ISOLATED<BR>
			NETWORKS, LIMITED NETWORK CONNECTIVITY, OR DEVELOPER ENDPOINTS.<BR>
			THE DEVELOPER OF VULNERABLE WEB APPLICATION IS NOT RESPONSIBLE FOR HOW THIS<BR>
			APPLICATION IS USED. 
