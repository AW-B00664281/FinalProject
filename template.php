...
<html>
	...
	<body>		
		...
		<header id="header">
			<h1>Insert the Vulnerability Title Here :)</h1>
		</header>
		...
		<div id="innerbody">
			...
			<!-- Introduction, History, How to Execute the Vulnerability -->
			
			####<br>
			<br>
			<!-- Unsecured Exploit Code -->
			
			####<br>
			<br>
			
			<!-- How to Secure the Vulnerability -->
			
			####<br>
			<br>
			<!-- Secured Code Variant -->
